...
| dj_16 | `-s 8 -t 2 -i 1000 --backtrack 3` | **567.0** (729.0) | 31/31 | 24 (17) | [open](http://localhost:8765/best/dj_16__s8t2i1000_bt_interactive.html) |
...
| vqe_16 | `-s 4 -t 2 -i 1000 --backtrack 3` | **3645.0** (3888.0) | 82/82 | 214 (152) | [open](http://localhost:8765/best/vqe_16__s4t2i1000_bt_interactive.html) |
...
| qaoa_16 | `-s 8 -t 2 -i 1000 --backtrack 3` (was `-s 4 -t 2`: 4050 / 152 s) | **3888-3969** (4941.0) | 48/48 | 225-230 (261) | [open](http://localhost:8765/best/qaoa_16__s4t2i1000_interactive.html) |

`--backtrack k`: k alternatives, MCTS rung on all of them first, then the ceiling-retry rung (jobs 4899/4900). dj/qaoa HTML artifacts for the k-configs are pending regeneration; the linked files are the earlier `--backtrack 1` (uncapped) / `-s 4` runs.
